...
* js日期加减：可以通过date.setDate()方法

  [JavaScript日期加减 - wenbin_ouyang - 博客园 (cnblogs.com)](https://www.cnblogs.com/xy-ouyang/p/12217167.html)
...
* css属性：pointer-events
  ...
  可以将上层元素设置为`pointer-events: none;`，起到上层元素遮挡下层元素，但不影响下层元素的点击事件的效果。
